...
class FUIAuthViewController: UITableViewController {
  ...
  override func viewDidLoad() {
    ...
    let phoneStyle = FUIPhoneStyle()
    phoneStyle.navigationBarColor = UIColor.yellow
    phoneStyle.navigationBarBackText = ""
    phoneStyle.navigationBarCancelImage = UIImage(named: "icon_close")
    ...
    let phoneVerificationStyle = FUIPhoneVerificationStyle()
    phoneVerificationStyle.backgroundColor = UIColor.white
    phoneVerificationStyle.navigationBarTitleText = "Test Title"
    phoneVerificationStyle.instructionsText = "Test Instructions. Code length: %@"
    phoneVerificationStyle.instructionsColor = UIColor.red
    phoneVerificationStyle.instructionsFont = UIFont.systemFont(ofSize: 18.0, weight: .regular)
    phoneVerificationStyle.codeTextFieldColor = UIColor.red
    phoneVerificationStyle.phoneNumberColor = UIColor.red
    phoneVerificationStyle.phoneNumberFont = UIFont.systemFont(ofSize: 18.0, weight: .regular)
    phoneVerificationStyle.resendCounterText = "Test Counter: %@"
    phoneVerificationStyle.resendCounterColor = UIColor.red
    phoneVerificationStyle.resendCounterFont = UIFont.systemFont(ofSize: 14.0, weight: .regular)
    phoneVerificationStyle.resendCounterUnderlined = true
    phoneVerificationStyle.resendButtonText = "Test Resend Button"
    phoneVerificationStyle.resendButtonColor = UIColor.green
    phoneVerificationStyle.resendButtonFont = UIFont.systemFont(ofSize: 14.0, weight: .regular)
    phoneVerificationStyle.resendButtonUnderlined = true
    phoneVerificationStyle.nextButtonImage = UIImage(named: "button_circle-next_active")
    phoneVerificationStyle.nextButtonDisabledImage = UIImage(named: "button_circle-next_deactive")
    phoneVerificationStyle.showPrivacyPolicy = false
    self.authUI?.phoneVerificationStyle = phoneVerificationStyle
